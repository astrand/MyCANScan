...
int PriusValues[] =
    { 0x2, 0x20, 0x22, 0x23, 0x25, 0x30, 0x38, 0x39, 0x3A, 0x3B, 0x3E, 0x60, 0x87, 0xB0, 0xB1, 0xB3,
0xB4, 0xC9, 0x120, 0x230, 0x244, 0x262, 0x348, 0x34F, 0x3C8, 0x3C9, 0x3CA, 0x3CB, 0x3CD, 0x3CF, 0x423,
0x4C1, 0x4C3, 0x4C6, 0x4C7, 0x4C8, 0x4CE, 0x4D0, 0x4D1, 0x520, 0x521, 0x526, 0x527, 0x528, 0x529, 0x52C,
0x540, 0x553, 0x554, 0x56D, 0x57F, 0x591, 0x5A4, 0x5B2, 0x5B6, 0x5C8, 0x5CC, 0x5D4, 0x5EC, 0x5ED, 0x5F8,
0x602, 0xC00, 0xFFF };
#endif
...
void
PrintHexa(int NumOfDigits, int Number)
{
    register int a, b;
...
void
AddToResultsBuffer(int NewValue)
{
    register int a;
...
void
CWalkThisMany(int npc, int tm, int frh)
{
...
void
GiveCombo(int npc, int lacr, int lamr)
{
    int ac, am, b, c, d;
