...
#define KM_CTRL		2
#define	KM_ALT		4
enum {SK_F1=210,SK_F2,SK_F3,SK_F4,SK_F5,SK_F6,SK_F7,SK_F8,SK_F9,SK_F10,SK_F11,SK_F12,SK_UPAR,SK_DNAR,SK_LFAR,SK_RIAR,SK_HOME,SK_PGUP,SK_PGDN,SK_END};
...
extern char *CreatePicture(unsigned int *ret_width, unsigned int *ret_height, int *SrcBufferSize);
...
extern void GR_DrawFillRectangle(int gx1,int gy1,int gx2,int gy2,int mode, unsigned char GRv_FwdR, unsigned char GRv_FwdG, unsigned char GRv_FwdB);
...
extern void GR_PutPixel(int x, int y, unsigned char GRv_BckR, unsigned char GRv_BckG, unsigned char GRv_BckB);
extern void GR_GetPixel(int x, int y, unsigned char *GRv_BckR, unsigned char *GRv_BckG, unsigned char *GRv_BckB);
...
extern int	SavePNGFile(char *FileName, char *SrcBuffer, int Width, int Height, int NumOfComponent);
